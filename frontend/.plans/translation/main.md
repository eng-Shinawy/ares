...
- **Types**: 17/94 split (common, auth, errors + 7 auth + 7 customer page types done; 77 remaining)
- **English**: 17/94 split (common, auth, errors + 7 auth + 7 customer page translations done; 77 remaining)
- **Arabic**: 17/94 split (common, auth, errors + 7 auth + 7 customer page translations done; 77 remaining)
...
- [ ] [Driver Detail](pages/dashboard/admin/drivers/_id.md) — `/(dashboard)/admin/drivers/[id]`
...
- [ ] [Create Supplier](pages/dashboard/admin/suppliers/create.md) — `/(dashboard)/admin/suppliers/create`
- [ ] [Supplier Detail](pages/dashboard/admin/suppliers/_supplierId.md) — `/(dashboard)/admin/suppliers/[supplierId]`
- [ ] [Edit Supplier](pages/dashboard/admin/suppliers/_supplierId/edit.md) — `/(dashboard)/admin/suppliers/[supplierId]/edit`
- [ ] [Admin Users](pages/dashboard/admin/users.md) — `/(dashboard)/admin/users`
- [ ] [Create User](pages/dashboard/admin/users/create.md) — `/(dashboard)/admin/users/create`
- [ ] [User Detail](pages/dashboard/admin/users/_id.md) — `/(dashboard)/admin/users/[id]`
- [ ] [Edit User](pages/dashboard/admin/users/_id/edit.md) — `/(dashboard)/admin/users/[id]/edit`
- [ ] [Admin Vehicles](pages/dashboard/admin/vehicles.md) — `/(dashboard)/admin/vehicles`
- [ ] [Create Vehicle](pages/dashboard/admin/vehicles/create.md) — `/(dashboard)/admin/vehicles/create`
- [ ] [Vehicle Detail](pages/dashboard/admin/vehicles/_id.md) — `/(dashboard)/admin/vehicles/[id]`
- [ ] [Verifications](pages/dashboard/admin/verifications.md) — `/(dashboard)/admin/verifications`
