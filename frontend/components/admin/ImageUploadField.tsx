    ...
    <>
      ...
      {imagePreview ? (
        <Box>
          ...
          >
            <Image src={imagePreview} alt={previewAlt} fill style={{ objectFit: "cover" }} />
          </Box>
          <Stack direction="row" spacing={1}>
            ...
            <Button size="small" variant="outlined" color="error" disabled={disabled} onClick={handleRemoveImage}>
              {removeImageLabel}
            </Button>
          </Stack>
        </Box>
