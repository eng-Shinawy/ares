...
{
    Task<List<AboutSectionDto>> GetAllAsync(string? locale = null, CancellationToken ct = default);
    Task<AboutSectionDto> GetByIdAsync(Guid id, string? locale = null, CancellationToken ct = default);
